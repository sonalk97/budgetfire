...
const Categorizer = {
  ...
  rules: [
    ...
    { keywords: ['delta air', 'indigo', 'flight', 'airline', 'airways', 'united air', 'american air', 'southwest', 'jetblue', 'spirit air', 'frontier air', 'chase travel', 'grab', 'hotel', 'marriott', 'hilton', 'hyatt', 'airbnb', 'vrbo', 'booking.com', 'expedia', 'kayak', 'hopper', 'hostel', 'resort'], category: 'Travel' },
