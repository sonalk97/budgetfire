...
const Categorizer = {
  ...
  rules: [
    ...
    // Dining
    { keywords: ['starbucks', 'mcdonald', 'chipotle', 'chick-fil-a', 'taco bell', 'wendy', 'burger king', 'subway', 'dunkin', 'domino', 'pizza', 'grubhub', 'doordash', 'uber eat', 'ubereats', 'postmates', 'restaurant', 'cafe', 'coffee', 'diner', 'bistro', 'grill', 'sushi', 'ramen', 'thai', 'chinese food', 'indian food', 'panda express', 'panera', 'five guys', 'shake shack', 'popeyes', 'kfc', 'arby', 'sonic drive', 'waffle house', 'ihop', 'denny', 'applebee', 'olive garden', 'outback', 'cheesecake factory', 'buffalo wild', 'wingstop', 'jack in the box', 'in-n-out', 'chili\'s', 'cracker barrel', 'red lobster', 'texas roadhouse', 'sweetgreen', 'cava', 'noodles', 'bakery', 'bar ', 'pub ', 'tavern', 'brewery', 'toast tab', 'square meal', 'eatery', 'savoy', 'convenience', 'deli'], category: 'Dining' },

    // Transportation
    { keywords: ['uber', 'lyft', 'taxi', 'gas station', 'shell', 'chevron', 'exxon', 'mobil', 'bp ', 'sunoco', 'marathon', 'speedway', 'wawa', 'parking', 'toll', 'ez pass', 'ezpass', 'metro', 'transit', 'mta', 'bart', 'caltrain', 'amtrak', 'greyhound', 'car wash', 'jiffy lube', 'autozone', 'advance auto', 'o\'reilly', 'tire', 'mechanic', 'car repair', 'dmv', 'registration', 'path', 'delta'], category: 'Transportation' },
