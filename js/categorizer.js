...
const Categorizer = {
  ...
  rules: [
    // Housing
    { keywords: ['rent', 'mortgage', 'hoa', 'property tax', 'home depot', 'lowes', 'lowe\'s', 'zillow', 'realtor', 'apartment', 'lease'], category: 'Housing' },
    ...
    // Groceries
    { keywords: ['walmart', 'costco', 'kroger', 'safeway', 'trader joe', 'whole foods', 'aldi', 'publix', 'heb', 'h-e-b', 'meijer', 'grocery', 'groceries', 'sprouts', 'food lion', 'giant eagle', 'wegmans', 'target', 'sam\'s club', 'bj\'s', 'market basket', 'piggly', 'winn dixie', 'stop & shop', 'shoprite', 'albertsons', 'food mart', 'fresh market', 'instacart'], category: 'Groceries' },

    // Dining
    { keywords: ['starbucks', 'mcdonald', 'chipotle', 'chick-fil-a', 'taco bell', 'wendy', 'burger king', 'subway', 'dunkin', 'domino', 'pizza', 'grubhub', 'doordash', 'uber eat', 'ubereats', 'postmates', 'restaurant', 'cafe', 'coffee', 'diner', 'bistro', 'grill', 'sushi', 'ramen', 'thai', 'chinese food', 'indian food', 'panda express', 'panera', 'five guys', 'shake shack', 'popeyes', 'kfc', 'arby', 'sonic drive', 'waffle house', 'ihop', 'denny', 'applebee', 'olive garden', 'outback', 'cheesecake factory', 'buffalo wild', 'wingstop', 'jack in the box', 'in-n-out', 'chili\'s', 'cracker barrel', 'red lobster', 'texas roadhouse', 'sweetgreen', 'cava', 'noodles', 'bakery', 'bar ', 'pub ', 'tavern', 'brewery', 'toast tab', 'square meal', 'eatery'], category: 'Dining' },

    // Transportation
    { keywords: ['uber', 'lyft', 'taxi', 'gas station', 'shell', 'chevron', 'exxon', 'mobil', 'bp ', 'sunoco', 'marathon', 'speedway', 'wawa', 'parking', 'toll', 'ez pass', 'ezpass', 'metro', 'transit', 'mta', 'bart', 'caltrain', 'amtrak', 'greyhound', 'car wash', 'jiffy lube', 'autozone', 'advance auto', 'o\'reilly', 'tire', 'mechanic', 'car repair', 'dmv', 'registration'], category: 'Transportation' },
  ...
  async categorizeAll(transactions) {
    ...
    for (const txn of transactions) {
      ...
      if (!matched) {
        txn.category = this.categorize(txn.description);
      }
    }
